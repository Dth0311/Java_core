...
public class Test {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice){
                case 0:
                    showMessage("Cảm ơn đã sử đụng dịch vụ!");
                    break;
                case 1:
                ...
                case 3:
                    if (employees.size() > 0){
                        ...
                        if (result.size() > 0){
                            showMessage("Tìm thấy " + result.size() + " kết quả");
                            showEmployees(result);
                        }else {
                           showMessage("Không tìm thấy nhân viên nào tên " + name);
                        }
                    }else {
                ...
                case 4:
                    if (employees.size() > 0){
                        showMessage("Nhập mức lương cần tìm: ");
                ...
                case 6:
                    if (employees.size() > 0){
                        ...
                        if (isDeleted){
                            ...
                            showMessage("Không có mã nhân viên đã nhập");
                        }
                    }else {
                        showMessage("Danh sách rỗng");
                    }
                ...
                case 9:
                    if (employees.size() > 0) {
                        ...
                        showMessage("Dánh sách nhân viên rỗng");
                    }
                    break;
                case 10:
                    if (employees.size() > 0){
                ...
                case 12:
                    if (employees.size()>0){
                        ...
                        showMessage("Dánh sách nhân viên rỗng. Ghi file thất bại");
                    }
                    break;
                default:
    ...
    private static void caculBonus(ArrayList<Employee> employees) {
    ...
    private static boolean removeEmp(ArrayList<Employee> employees, String id) {
        for (int i = 0; i < employees.size(); i++) {
            // nếu thấy mã nhân viên nào trùng
    ...
    private static ArrayList<Employee> searchBySalary(ArrayList<Employee> employees, float salary) {
    ...
    private static void updateEmployeeId(ArrayList<Employee> employees) {
        int maxId = 1000; // giả định ban đầu rằng chưa có nhân viên nào
        ...
        for (var emp: employees
            ...
            if (curId > maxId){ // nếu mã này lớn hơn mã nhân viên max
                maxId = curId; // cập nhật mã maxId
            }
        }
        // thiết lập mã cho nhân viên kết tiếp
