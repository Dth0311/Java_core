...
public class Motobike extends Vehicle{
    ...
    public Motobike(int numOfWheel, String name, String color, String typeOfEnergy,
                    String tireType, String cylinderCapacity, float traveledDistance) {
        this.numOfWheel = numOfWheel;
        this.name = name;
        this.color = color;
    ...
    public Motobike(String brand, int year, String madeIn, float price, String size, float weight,
                    String lisensePlate, int numOfWheel, String name, String color, String typeOfEnergy,
                    String tireType, String cylinderCapacity, float traveledDistance) {
