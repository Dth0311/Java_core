...
public class Bus extends Automobile{
    ...
    private int numOfPT; // số lượng khách đã chuyên chỏ được
    ...
    public Bus(int numOfSeats, float maxPayload, float orbit, float fuelTankCapacity, int numOfPT) {
    ...
    public Bus(int numOfWheel, String engineType, String name, String color, Owner owner,
               int numOfSeats, float maxPayload, float orbit, float fuelTankCapacity, int numOfPT) {
