...
public class GraduatedStudent extends Student {
    ...
    private int failed; // số môn tạch
    ...
    public GraduatedStudent(String studentId, String schoolName, String className, String major,
                            float avgGrade, int graduatedYear, int creditRetake, int failed,
                            float startingSalary, String compayName, String role) {
    ...
    public GraduatedStudent(String id, String fullName, String address, Date dateOfBirth,
                            String email, String phoneNumber, String studentId, String schoolName,
                            String className, String major, float avgGrade, int graduatedYear,
                            int creditRetake, int failed, float startingSalary, String compayName, String role) {
        super(id, fullName, address, dateOfBirth, email, phoneNumber, studentId, schoolName, className, major, avgGrade);
        this.graduatedYear = graduatedYear;
        this.creditRetake = creditRetake;
        this.failed = failed;
        this.startingSalary = startingSalary;
    ...
    public void registerPostgraduate(String subject) {
        System.out.println("Cựu sinh viên đang đăng kí học cao học môn " + subject);
    }
