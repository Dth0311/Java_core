...
import Ex3.Comparator.SortInstructorByExperienceDESC;
import Ex3.Comparator.SortInstructorByGradeDESC;
import Ex3.Comparator.SortInstructorByNameASC;
import Ex3.Comparator.SortInstructorBySalaryDESC;
...
public class Test {
        ...
        do {
            ...
            switch (choice){
                case 0:
                    ...
                    break;
                case 1:
                    Instructor instructor = creatInstructor(input);
                ...
                case 7:
                    if (students.size() > 0) {
                        Collections.sort(students, new SortInstructorByGradeDESC());
                        showStudents(students);
                    } else {
                        showMessage("Danh sách sinh viên rỗng");
                    }
    ...
    /**
    * phương thức dùng để tạo đối tượng
    * @param input đối tượng nhập dữ liệu từ bàn phím
    * @return giảng viên với các thông tin đã tạo
    * */
    private static Instructor creatInstructor(Scanner input) {
