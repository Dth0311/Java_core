...
public class Manager extends Employee {
    ...
    public Manager(String id, String fullName, String address,
                   ...
                   String phoneNumber, String empId, String duty,
                   float salary, float experience,
                   float workingDay, float totalSalary,
                   float bonus, Date startDate, Date endDate) {
        super(id, fullName, address, dateOfBirth, email, phoneNumber, empId, duty, salary, experience, workingDay, totalSalary, bonus);
        this.startDate = startDate;
        this.endDate = endDate;
    }
