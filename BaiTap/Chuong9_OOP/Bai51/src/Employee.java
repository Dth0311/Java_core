...
public class Employee extends Person {
    ...
    public Employee(String id, String fullNameString, String address, Date dateOfBirth, String email, String phoneNumber, String empId, String duty, float salary, float totalSalary, float bonus) {
